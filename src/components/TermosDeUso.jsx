      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[92vh] flex flex-col overflow-hidden">
        ...
        <div className="flex-1 min-h-0 overflow-y-auto scroll-y-soft px-6 py-5 space-y-3 text-[10px] text-stone-600 leading-relaxed">
          ...
          <div className="space-y-2.5">
            ...
            <p><strong className="text-stone-800">4.1. Dados que coletamos, finalidade e direitos do titular.</strong> Em transparência (art. 9º da LGPD), a Plataforma coleta e trata: <strong>(i) dados de cadastro/identificação</strong> — nome, e-mail, CPF/CNPJ, senha (armazenada de forma criptografada, não legível pela Plataforma) e, opcionalmente, foto de perfil; <strong>(ii) dados de acesso e segurança</strong> — endereço IP, geolocalização, identificadores do dispositivo/navegador e registros (logs) de data/hora e ações realizadas na conta; <strong>(iii) dados de uso</strong> — configurações, integrações, campanhas, conteúdos, métricas e histórico de envios; <strong>(iv) dados de pagamento</strong> — processados por gateways terceirizados (ex.: Stripe); a Plataforma <strong>não armazena o número completo do cartão</strong>; <strong>(v) dados dos DESTINATÁRIOS</strong> que o Usuário cadastra, importa ou envia (nome, telefone, e-mail e demais campos), tratados <strong>exclusivamente como Operadora</strong>, por conta e ordem do Usuário. <strong>Finalidades:</strong> prestação, operação e segurança do serviço; execução das automações e disparos definidos pelo Usuário; prevenção a fraudes e abusos; cobrança; e cumprimento de obrigações legais e regulatórias. <strong>Compartilhamento:</strong> os dados podem ser compartilhados com os provedores necessários à execução (ex.: WhatsApp/Meta, Telnyx, SMSDev, Resend, Stripe, provedores de nuvem) e com autoridades mediante requisição legal. <strong>Direitos do titular:</strong> o Usuário pode solicitar acesso, correção, portabilidade, informação sobre compartilhamentos ou exclusão dos seus dados pelo suporte, ressalvada a guarda mínima exigida por lei (art. 15 da Lei nº 12.965/2014). Os dados são mantidos apenas pelo tempo necessário às finalidades e às obrigações legais.</p>
