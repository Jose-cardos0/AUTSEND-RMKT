...
const CARD = {
  inicial: {
    tag: 'Entrada',
    preco: 'R$67',
    features: ['2 trackers', 'Banco de Leads, Produtos, Checkouts, Templates', 'WhatsApp completo · 1 instância', '500 e-mails/mês · só API\'s (sem domínio)', 'Construtor, Funil e Métricas de e-mail'],
  },
  padrao: {
    tag: 'Mais popular',
    preco: 'R$127',
    features: ['10 trackers', 'Banco de Leads, Produtos, Checkouts, Templates', 'WhatsApp completo · 2 instâncias', '3.000 e-mails/mês · 1 domínio', 'Construtor, Funil e Métricas de e-mail'],
  },
  pro: {
    tag: 'Máximo',
    preco: 'R$197',
    features: ['20 trackers', 'Tudo do Padrão, sem travas', 'WhatsApp · 4 instâncias', '10.000 e-mails/mês · 2 domínios', 'Limites maiores e prioridade'],
  },
}
