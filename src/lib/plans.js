...
export const PLANOS = {
  free: {
    ...
    limites: { trackers: 1, instancias: 0, emailsMes: 50, dominios: 0, templates: 1, gruposProduto: 1, produtosPorGrupo: 1 },
    features: {
  ...
  inicial: {
    ...
    limites: { trackers: 2, instancias: 1, emailsMes: 500, dominios: 0 },
    features: {
  ...
  padrao: {
    nome: 'Padrão',
    limites: { trackers: 10, instancias: 2, emailsMes: 3000, dominios: 1 },
    features: {
      bancoLeads: true, produtos: true, checkouts: true, templates: true,
      waIntegracoes: true, waAutomacoes: true, waRemarketing: true, waGrupos: true, waDisparos: true, waFunil: true, waMetricas: true,
      emailIntegracoes: true, emailConstrutor: true, emailAutomacoes: true, emailAutomacoesSoAprovada: false, emailDisparos: true, emailFunil: true, emailMetricas: true,
  ...
  pro: {
    nome: 'Pro',
    limites: { trackers: 20, instancias: 4, emailsMes: 10000, dominios: 2 },
    features: {
      bancoLeads: true, produtos: true, checkouts: true, templates: true,
      waIntegracoes: true, waAutomacoes: true, waRemarketing: true, waGrupos: true, waDisparos: true, waFunil: true, waMetricas: true,
      emailIntegracoes: true, emailConstrutor: true, emailAutomacoes: true, emailAutomacoesSoAprovada: false, emailDisparos: true, emailFunil: true, emailMetricas: true,
...
export const LIMITE_LABELS = { trackers: 'Trackers', instancias: 'Instâncias WhatsApp', emailsMes: 'E-mails/mês', dominios: 'Domínios de e-mail' }
