...
export const PLANOS = {
  free: {
    ...
    limites: { trackers: 1, instancias: 0, emailsMes: 50, smsMes: 0, dominios: 0, iaMes: 0, atendentes: 0, conversasMes: 0, templates: 1, gruposProduto: 1, produtosPorGrupo: 1 },
    features: {
  ...
  inicial: {
    ...
    limites: { trackers: 2, instancias: 1, emailsMes: 500, smsMes: 200, dominios: 1, iaMes: 30, atendentes: 1, conversasMes: 100 },
    features: {
  ...
  padrao: {
    nome: 'Padrão',
    limites: { trackers: 10, instancias: 2, emailsMes: 2500, smsMes: 500, dominios: 1, iaMes: 100, atendentes: 2, conversasMes: 200 },
    features: {
      bancoLeads: true, produtos: true, checkouts: true, templates: true,
      waIntegracoes: true, waAutomacoes: true, waRemarketing: true, waGrupos: true, waDisparos: true, waFunil: true, waMetricas: true,
      emailIntegracoes: true, emailConstrutor: true, emailAutomacoes: true, emailAutomacoesSoAprovada: false, emailDisparos: true, emailFunil: true, emailMetricas: true,
  ...
  pro: {
    nome: 'Pro',
    limites: { trackers: 20, instancias: 4, emailsMes: 5000, smsMes: 1000, dominios: 2, iaMes: 200, atendentes: 3, conversasMes: 300 },
    features: {
      bancoLeads: true, produtos: true, checkouts: true, templates: true,
      waIntegracoes: true, waAutomacoes: true, waRemarketing: true, waGrupos: true, waDisparos: true, waFunil: true, waMetricas: true,
      emailIntegracoes: true, emailConstrutor: true, emailAutomacoes: true, emailAutomacoesSoAprovada: false, emailDisparos: true, emailFunil: true, emailMetricas: true,
...
export const LIMITE_LABELS = { trackers: 'Trackers', instancias: 'Instâncias WhatsApp', emailsMes: 'E-mails/mês', smsMes: 'SMS/mês (EUA)', dominios: 'Domínios de e-mail', iaMes: 'E-mails com IA/mês', atendentes: 'Vendedores IA', conversasMes: 'Conversas do Vendedor/mês' }
